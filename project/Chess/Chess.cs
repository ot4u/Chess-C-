...
namespace Chess
{
    public class Chess
    {
        ...
        public Chess(UIBoard ui, int nPlayers = 1, bool setupBoard = true)
        {
            // callback setup
            this.m_UI = ui;
            this.m_UI.SetStatus(true, "Генерация...");
            ...
            this.m_UI.SetStatus(false, "Ход белых.");
        }
        ...
        public void AISelect()
        {
            ...
            // ai is dump
            this.m_UI.SetStatus(true, "Думает...");
        ...
        private void MakeMove(move_t m)
        {
            ...
            string move = (this.Turn == Player.WHITE) ? "Б" : "Ч";
        ...
        private void switchPlayer()
        {
            ...
            this.m_UI.SetStatus(false, ((this.Turn == Player.WHITE) ? "Белые" : "Черные") + " ходят.");
        ...
        public bool detectCheckmate()
        {
            ...
            if (!LegalMoveSet.hasMoves(this.Board, this.Turn))
            {
                ...
                {
                    this.m_UI.LogMove("Мат!\n");
                    this.m_UI.SetStatus(false, ((this.Turn == Player.WHITE) ? "Черные" : "Белые") + " выиграли!");
                }
                else
                {
                    this.m_UI.LogMove("Пат!\n");
                }
                return true;
            }
            else if (wkingonly && bkingonly)
            {
                this.m_UI.LogMove("Ничья.\n");
                return true;
            }
            return false;
        }
